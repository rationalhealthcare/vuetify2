...
<template>
    <v-sheet class="mx-auto" max-width="500">
        <v-list class="px-0 mx-0 overflow-y-auto" max-height="225">
            <v-list-item-group
                v-model="selected"
                active-class="secondary lighten-2"
                dense
            >
                <v-list-item
                        ...
                        <v-row class="fill-height">
                            <v-card-title class="white--text pl-9 pt-9">
                                <div
                                    ...
                                    v-if="
                                        this.selectedItem.entitytypecode === '1'
                                    "
                                >
                                ...
                                <div
                                    class="display-1 pl-9 pt-9"
                                    v-if="
                                        this.selectedItem.entitytypecode === '2'
                                    "
                                >
                    ...
                    <v-list two-line>
                        ...
                        >
                            ...
                            <v-list-item-content>
                                ...
                                <v-list>
                                    <v-list-item
                                        v-for="(phone, j) in address.phones"
                                        :key="j"
                                    >
                                        <v-list-item-icon>
